...
public class RejectBooking extends HttpServlet{
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement st = conn.prepareStatement("UPDATE Booking set status='Rejected' where bid=?");
        ...
        "<span class='dot'></span>"+
        "</div></nav><br><br><br><br>"+
        "<div class='outer'><h2>Booking Request Rejected</h2><br><br>"+
