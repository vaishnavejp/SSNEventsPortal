    ...
    throws ServletException, IOException {
        ...
        if(type.equals("admin")) {
           ...
           // out.println("<nav class='navTab'><p class='navTabText' style='font-size: 24px; font-weight: bold;'>SSN Events Portal</p><div class='rightHalf'><a href='#' class='navTabText'>Dashboard</a><a href='#'' class='navTabText'>Past Events</a><a href='#' class='navTabText' style='font-weight:bold'>Uploads</a><div class='dropdown'><a class='navTabText'>Infrastructure</a><div class='dropdown-content'><a href='#'>Book</a><a href='#'>History</a></div></div><span class='dot'></span></div></nav><br><br><br>");
            ...
            "<a href='http://localhost:8080/MiniProject/PastEvents' class='navTabText' style='font-weight:bold'>Past Events</a>"+
            ...
            out.println("<nav class='navTab'><p class='navTabText' style='font-size: 24px; font-weight: bold;'>SSN Events Portal</p><div class='rightHalf'><a href='http://localhost:8080/MiniProject/Dashboard' class='navTabText'>Dashboard</a><a href='http://localhost:8080/MiniProject/PastEvents' class='navTabText' style='font-weight:bold'>Past Events</a><span class='dot'></span></div></nav><br><br><br>");
        }
        ...
        try {
            ...
            out.println("<h1 style='color:#501EDA; margin-left:2%'> Past Events </h1>");
            ...
            out.println("<div class='month' < '2023-05-06'" + 
                "<h1>May 2023 </h1> </div>" +
                "<ul class='weekdays'>" + 
                "<li>Mo</li>" +
                "<li>Tu</li>" +
